...
//         assert(quote.author !== 'undefined' && quote.text !== 'undefined');
//     });
...
//                         }
//         assert(quote.author === firstQuote.author && quote.text === firstQuote.text);
...
//             else done(err, quotes.length === 102)
//             });
//         })
//     });
// });
...
//             Quote.getQuotesFromDB(function(err, quotes){
//                 done(err, quotes.indexOf(quote) !== -1);
//             });
//         });
//     });
...
//             Quote.getQuotesFromDB(function(err, quotes){
//                 done(err, quotes.indexOf(quote) === 0);
//             });
//         });
//     });
// });
